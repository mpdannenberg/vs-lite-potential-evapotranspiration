...
print('-dtiff','-f1','-r300','./output/supplemental-bcsd-trend-trw-rcp45.tif')
close all;
...
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r300','./output/supplemental-bcsd-trend-gM-rcp45.tif')
close all;
...
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r300','./output/supplemental-bcsd-trend-soilmoisture-rcp45.tif')
close all;
...
set(gcf,'PaperPositionMode','auto')
print('-dtiff','-f1','-r300','./output/supplemental-bcsd-trend-pet-rcp45.tif')
close all;
